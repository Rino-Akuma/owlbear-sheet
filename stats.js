...
function recalc(){
  ...
  pass_perception.textContent =
    10 + wisv + (document.getElementById("skill_perception").dataset.state!="0" ? parseInt(pb.value) : 0);

  pass_insight.textContent =
    10 + wisv + (document.getElementById("skill_insight").dataset.state!="0" ? parseInt(pb.value) : 0);

  pass_investigation.textContent =
    10 + intv + (document.getElementById("skill_investigation").dataset.state!="0" ? parseInt(pb.value) : 0);
